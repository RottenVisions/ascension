...
namespace Ascension.Compiler
{
    public static class Dom
    {
        ...
        public static void Call(this CodeStatementCollection stmts, CodeExpression expr, string method,
        ...
        {
            member.DeclareObsolete(
                "Modify and the using(var modify = ...) syntax is deprecated. Change properties directly instead.");
        }
        ...
        public static void IfDef(this CodeStatementCollection stmts, string symbol,
            Action<CodeStatementCollection> ifdef)
        {
        ...
        public static CodeMemberMethod DeclareMethod(this CodeTypeDeclaration type, Type returnType, string methodName,
            Action<CodeMemberMethod> body)
        {
            return DeclareMethod(type, returnType.FullName, methodName, body);
        }

        public static CodeMemberMethod DeclareMethod(this CodeTypeDeclaration type, string returnType, string methodName,
            Action<CodeMemberMethod> body)
        {
        ...
        public static CodeMemberProperty DeclareProperty(this CodeTypeDeclaration type, string propertyType,
            string propertyName, Action<CodeStatementCollection> getter)
        {
            return DeclareProperty(type, propertyType, propertyName, getter, null);
        }

        public static CodeMemberProperty DeclareProperty(this CodeTypeDeclaration type, string propertyType,
            string propertyName, string getter)
        {
            return DeclareProperty(type, propertyType, propertyName, get => get.Expr(getter), null);
        }

        public static CodeMemberProperty DeclareProperty(this CodeTypeDeclaration type, string propertyType,
            string propertyName, string getter, string setter)
        {
            if (setter != null)
            {
                return DeclareProperty(type, propertyType, propertyName, get => get.Expr(getter),
                    set => set.Expr(setter));
            }
            return DeclareProperty(type, propertyType, propertyName, get => get.Expr(getter), null);
        }
        ...
        public static CodeMemberProperty DeclareProperty(this CodeTypeDeclaration type, string propertyType,
            string propertyName, Action<CodeStatementCollection> getter, Action<CodeStatementCollection> setter)
        {
        ...
        public static void For(this CodeStatementCollection stmts, string variableName, CodeExpression testExpression,
        ...
        public static CodeVariableReferenceExpression DeclareParameter(this CodeMemberProperty method, string paramType,
            string paramName)
        {
        ...
        public static CodeVariableReferenceExpression DeclareParameter(this CodeMemberMethod method, string paramType,
            string paramName)
        {
            method.Parameters.Add(new CodeParameterDeclarationExpression(paramType, paramName));
            return new CodeVariableReferenceExpression(paramName);
        ...
        {
            return (value.GetType().FullName.Replace("Ascension.Compiler", "Ascension.Networking") + "." + value).Expr();
        }
        ...
        {
            return new CodeSnippetExpression(value + "f");
        }
